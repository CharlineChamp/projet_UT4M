...
```{r}
# Représentation graphique de la qualité du sommeil en fonction du temps
...
```{r}
# Représentation graphique de la qualité du sommeil en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la qualité du sommeil en fonction du temps des coureurs du 160km
...
```{r}
# Collecte des données de la nuit 7 jours avant la course
data_j7 <- data[data$day == "13/07/2023",]

# Analyse statistique de la qualité du sommeil en fonction de la course 7 jours avant le départ
p_val_course_j7 <- t.test(sleep_quality ~ race, data = data_j7)$p.value

# Analyse statistique de la qualité du sommeil en fonction du résultat de la course 7 jours avant le départ
p_val_resultat_j7 <- t.test(sleep_quality ~ finisher, data = data_j7)$p.value

# Représentation graphique de la qualité du sommeil en fonction de la course 7 jours avant le départ
...
# Représentation graphique de la qualité du sommeil en fonction du résultat de la course 7 jours avant le départ
...
# Collecte des données de la nuit avant la course
data$dep_race <- ifelse(data$race == "100 km", "22/07/2023","21/07/2023")
data_jj <- data[data$day == data$dep_race,]

# Analyse statistique de la qualité du sommeil en fonction de la course la nuit avant le départ
p_val_course_jj <- t.test(sleep_quality ~ race, data = data_jj)$p.value

# Analyse statistique de la qualité du sommeil en fonction du résultat de la course la nuit avant le départ
p_val_resultat_jj <- t.test(sleep_quality ~ finisher, data = data_jj)$p.value

# Représentation graphique de la qualité du sommeil en fonction de la course la nuit avant le départ
...
# Représentation graphique de la qualité du sommeil en fonction du résultat de la course la nuit avant le départ
...
# Graphique de qualité du sommeil en fonction de la course effectuée
grid.arrange(graph_course_j7, graph_course_jj, ncol = 2)

# Graphique de qualité du sommeil en fonction du résultat
grid.arrange(graph_resultat_j7, graph_resultat_jj, ncol = 2)

# Résultats des tests mis en forme
...
# Modèle mixte de la qualité du sommeil en fonction de la date des coureurs du 100km
...
# Modèle mixte de la qualité du sommeil en fonction de la date des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure du coucher en fonction du temps
...
```{r}
# Représentation graphique de l'heure du coucher en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure du coucher en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure du réveil en fonction du temps
...
```{r}
# Représentation graphique de l'heure du réveil en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure du réveil en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'entraînement en fonction du temps
...
```{r}
# Représentation graphique de l'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique du sport effectué en fonction du temps
...
```{r}
# Représentation graphique du sport effectué en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique du sport effectué en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure de début d'entraînement en fonction du temps
...
```{r}
# Représentation graphique de l'heure de début d'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure de début d'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure de fin d'entraînement en fonction du temps
...
```{r}
# Représentation graphique de l'heure de fin d'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure de fin d'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique du thème d'entraînement en fonction du temps
...
```{r}
# Représentation graphique du thème d'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique du thème d'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la perception de l'effort en fonction du temps
...
```{r}
# Représentation graphique de la perception de l'effort en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la perception de l'effort en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la distance parcourue en fonction du temps
...
```{r}
# Représentation graphique de la distance parcourue en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la distance parcourue en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique du dénivelé effectué en fonction du temps
...
```{r}
# Représentation graphique du dénivelé effectué en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique du dénivelé effectué en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la prise d'alimentation à l'entraînement en fonction du temps
...
```{r}
# Représentation graphique de la prise d'alimentation à l'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la prise d'alimentation à l'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'hydratation à l'entraînement en fonction du temps
...
```{r}
# Représentation graphique de l'hydratation à l'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'hydratation à l'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique du type d'hydratation à l'entraînement en fonction du temps
...
```{r}
# Représentation graphique du type d'hydratation à l'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique du type d'hydratation à l'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique du volume d'hydratation à l'entraînement en fonction du temps
...
```{r}
# Représentation graphique du volume d'hydratation à l'entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique du volume d'hydratation à l'entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique d'un second entraînement en fonction du temps
...
```{r}
# Représentation graphique d'un second entraînement en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique d'un second entraînement en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la prise d'un petit-déjeuner en fonction du temps
...
```{r}
# Représentation graphique de la prise d'un petit-déjeuner en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la prise d'un petit-déjeuner en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure de la prise du petit-déjeuner en fonction du temps
...
```{r}
# Représentation graphique de l'heure de la prise du petit-déjeuner en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure de la prise du petit-déjeuner en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la prise d'une collation matinale en fonction du temps
...
```{r}
# Représentation graphique de la prise d'une collation matinale en fonction du temps des coureurs du 100km 
...
```{r}
# Représentation graphique de la prise d'une collation matinale en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure de la prise d'une collation matinale en fonction du temps
...
```{r}
# Représentation graphique de l'heure de la prise d'une collation matinale en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure de la prise d'une collation matinale en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la prise d'un déjeuner en fonction du temps
...
```{r}
# Représentation graphique de la prise d'un déjeuner en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la prise d'un déjeuner en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure de la prise d'un déjeuner en fonction du temps
...
```{r}
# Représentation graphique de l'heure de la prise d'un déjeuner en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure de la prise d'un déjeuner en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la prise d'une collation dans l'après-midi en fonction du temps
...
```{r}
# Représentation graphique de la prise d'une collation dans l'après-midi en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la prise d'une collation dans l'après-midi en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de la prise d'un diner en fonction du temps
...
```{r}
# Représentation graphique de la prise d'un diner en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de la prise d'un diner en fonction du temps des coureurs du 160km
...
```{r}
# Représentation graphique de l'heure de la prise d'un diner en fonction du temps
...
```{r}
# Représentation graphique de l'heure de la prise d'un diner en fonction du temps des coureurs du 100km
...
```{r}
# Représentation graphique de l'heure de la prise d'un diner en fonction du temps des coureurs du 160km
